  ...
  <body>
    ...
    <main>
      <div class="container-fluid">
        ...
        <p id="phead">
          ...
          Welcome to the Cashiers Section!
        </p><br><br>
        ...
        <div class="row justify-content-around">
         ...
         <div class="col-md-2 pcursor">
          ...
          <div class="col-md-2">
            <div id="containerimg1">
              <a onclick="showassign()" href="#tableshow">
  			    <img src="../icons/assignU.png" alt="assign" id="imageimg1">
  			    <div id="overlayimg1">
    		      <div id="textimg1">View Assigned Rooms list</div>
  			    </div>
              </a>
		    </div>
		  </div>
        ...
        <div class="row justify-content-around">       
          ...
          <div class="col-md-2">
            <div id="containerimg1">
              <a href="https://dhaliw91.myweb.cs.uwindsor.ca/4150/emp/invoicewrite.php">
  			    <img src="../icons/invU.png" alt="ins" id="imageimg1">
  			    <div id="overlayimg1">
    		      <div id="textimg1">Update Invoice Database</div>
  			    </div>
              </a>
		    </div>
		  </div>
          ...
          <div class="col-md-2">
            <div id="containerimg1">
              <a href="https://dhaliw91.myweb.cs.uwindsor.ca/4150/emp/assignwrite.php">
  			    <img src="../icons/assign.png" alt="assign" id="imageimg1">
  			    <div id="overlayimg1">
    		      <div id="textimg1">Update Assigned rooms/Monthly Rent</div>
  			    </div>
              </a>
		    </div>
		  </div>
		...
		<script>
          ...
          function showassign(){document.getElementById("tableshow").innerHTML = "<?php showassign(); ?>";}
		</script>
    </div>
    ...
    <?php 
      ...
      function showstu(){
        ...
        $p2q51 = $mysqli->query("SET @addressList = ''");
        $p2q52 = $mysqli->query("CALL paymentDue(@addressList)"); 
		$p2q50 = $mysqli->query("SELECT @addressList") or die(mysqli_error($mysqli));

        echo "<tr><th colspan='9'>List of Student who havn't paid thier invoices yet, with thier Home addresses.</th></tr>";
        while($row41 = $p2q50->fetch_assoc()):
          echo "<tr><td colspan='9'>".$row41['@addressList']."</td></tr>";
        endwhile;
         echo "<tr><td colspan='5'>P.S.- Kindly notify them by Mail.</td></tr>";
      ...
      function showassign(){
        $mysqli = new mysqli("localhost", "hajela_COMP4150", "root", "hajela_COMP4150") or die(mysqli_error($mysqli));
      	$assign = $mysqli->query("Select assign.PLACENUM, assign.G12NUM, student.STUDENT_NAME, assign.MONTHLY_RENT from assign, student where student.G12NUM = assign.G12NUM;") or die(mysqli_error($mysqli));
        //$row2 = $ins->fetch_assoc();
        echo "Assigned Rooms:";
        echo "<tr><th>Place Number</th><th>Student ID</th><th>Student Name</th><th>Monthly Rent</th></tr>";
        while($row0 = $assign->fetch_assoc()):
    	  echo "<tr><td>".$row0['PLACENUM']."</td><td>".$row0['G12NUM']."</td><td>".$row0['STUDENT_NAME']."</td><td>".$row0['MONTHLY_RENT']."</td></tr>";
        endwhile;
      }
