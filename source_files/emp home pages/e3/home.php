  ...
  <body>
    ...
    <main>
      <div class="container-fluid">
        ...
        <p id="phead">
          ...
          Welcome to the HR/Admin section!
        </p><br><br>
    ...
    <?php 
      ...
      function showstu(){
        ...
        $p2q1 = $mysqli->query("call P2Q1;") or die(mysqli_error($mysqli));
        echo "<tr><th>What needs to be done</th><th>Status of Assignment</th><th>Number of Unassigned Students</th><th>Last Date to be assigned</th><th>Has the date passed</th></tr>";
        while($row41 = $p2q1->fetch_assoc()):
    	  echo "<tr><td>".$row41['WHAT_TO_DO']."</td><td>".$row41['ASSIGNED_STATUS']."</td><td>".$row41['TOTAL_NUMBER_OF_UNASSIGNED_STUDENTS']."</td><td>".$row41['ASSIGNMENT_LAST_DATE']."</td><td>".$row41['DATE_PASSED']."</td></tr>";
        endwhile;               
      }
      function showadv(){
        $mysqli = new mysqli("localhost", "hajela_COMP4150", "root", "hajela_COMP4150") or die(mysqli_error($mysqli));
      ...
      function showres(){
        ...
        endwhile;
        echo "<tr><td>Notification</td></tr>";
        $p2q6 = $mysqli->query("call P2Q6;") or die(mysqli_error($mysqli));
        echo "<tr><td colspan='2'>List of rooms by flat, still vacant in the above Halls</td></tr>";
        echo "<tr><th>Flat Id</th><th>Number of Vacant rooms</th></tr>";
        while($row91 = $p2q6->fetch_assoc()):
    	  echo "<tr><td>".$row91['FLAT_ID']."</td><td>".$row91['NUMBER_OF_VACANT_ROOMS']."</td></tr>";
        endwhile; 
      }
